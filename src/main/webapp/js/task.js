 ...
 * 
 날      짜 : 2018. 7. 9
 기      능 : sday 변경 no redirect
 작성자명 : 김 정 권
 */
$( ".date_sday_noredirect" ).datepicker({
    showOn: "button",
    buttonImage: "img/calendar.png",
    buttonImageOnly: true,
    dateFormat: 'yy-mm-dd',
    onSelect: function(dateText, inst) {
    	...
    	if(yeartest){
    	  ...
    	  $.ajax(
    		       {
    		           type : "post",
    		           url  : "changesdayoftask_noredirect.htm",
    		           data : {
    		        	   'tid': tid,
    		        	   'sday' : date
    		           },
 ...
 * 
 ...
 작성자명 : 김 정 권
 */
$( ".date_eday_noredirect" ).datepicker({
    showOn: "button",
    buttonImage: "img/calendar.png",
    buttonImageOnly: true,
    dateFormat: 'yy-mm-dd',
    onSelect: function(dateText, inst) {
        ...
        $.ajax(
 		       {
 		           type : "post",
 		           url  : "changeedayoftask_noredirect.htm",
 		           data : {
 		        	   'tid': tid,
 		        	   'eday' : date
 		           },
