        ...
        <div class="main-body-twopannel-left-wrapper">
          ...
          <div class="main-body-twopannel-left-body">
            <div class="main-body-twopannel-left-body-wrapper">
            	<div class= "background_div-wrapper">
	            	<div id="background_div">
					
							<!-- 진행중인 task -->
							<div class="btn_div report_progress" data-toggle="modal" data-target="#report_info_modal" id="report_progress">
								<br>진행중인 Task<br>
							...
							<!-- Task 상태별 현황 -->
							<div class=" btn_div report_status" data-toggle="modal" data-target="#report_info_modal" id="report_status">
								<br>Task 상태별 현황<br>
							...
							<!-- 마감기한 지난 Task -->
							<div class=" btn_div report_expired" data-toggle="modal" data-target="#report_info_modal" id="report_expired">
								<br>마감기한이 지난 Task<br>
							...
							<!-- 마감기한이 임박한 Task -->
							<div class="btn_div report_drawnear" data-toggle="modal" data-target="#report_info_modal" id="report_drawnear">
