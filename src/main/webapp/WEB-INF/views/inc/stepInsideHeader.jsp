...
<nav class="navbar inside-header inside-header-step">
   <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
         ...
         <li class="nav-item"><a id ="timeline-page" class="nav-link header-menu">Timeline</a></li>
         <li class="nav-item"><a id ="workload-page" class="nav-link header-menu">Workload</a></li>
      </ul>
   </div>
</nav>